    ...
    try:
        ...
        if msg.attachments:
            ...
            for i, attachment in enumerate(msg.attachments):
                ...
                attachment.save(custom_filename=os.path.join(attachment_filename))
                #os.rename(attachment_filename, documentos_usuario)
                #os.chdir("C:\\Users\\kelvin.silveira\\Desktop\\Projetos\\MSG")
                #os.listdir()
                #for f in os.listdir():
                    #os.rename("teste.txt",documentos_usuario + "\\Anexos")
